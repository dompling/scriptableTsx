...
var Base = class {
  constructor() {
    ...
    this.setImage = async (img, key, notify = true) => {
      if (!img) {
        if (FILE_MGR_LOCAL.fileExists(key))
          FILE_MGR_LOCAL.remove(key);
      } else {
    ...
    this.showAlertCatchInput = async (title2, content, opt) => {
      ...
      if (confirm)
        await setSetting(this.BOX_CATCH_KEY, settings);
      return settings;
    };
  }
  async init() {
  ...
  constructor() {
    ...
    this.stackGasStation = (gasStation) => {
      return gasStation.map((item) => {
        return /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("wstack", {
        ...
        }, "油站：", item.title, "(", item._distance, "米)"), /* @__PURE__ */ h("wspacer", null)), /* @__PURE__ */ h("wspacer", {
          length: 2
        }), /* @__PURE__ */ h("wstack", {
          verticalAlign: "center"
        }, /* @__PURE__ */ h("wspacer", {
          ...
          font: 10,
          textColor: this.backgroundColor
        }, "电话：", item.tel), /* @__PURE__ */ h("wspacer", null)), /* @__PURE__ */ h("wspacer", {
          length: 2
        }), /* @__PURE__ */ h("wstack", {
          verticalAlign: "center"
        }, /* @__PURE__ */ h("wspacer", {
          ...
          font: 10,
          textColor: this.backgroundColor
        }, "地址：", item.address), /* @__PURE__ */ h("wspacer", null))), /* @__PURE__ */ h("wspacer", null));
      });
    };
    this.render = async () => {
      let gasStation = [];
      ...
      }, "今日油价")), /* @__PURE__ */ h("wspacer", null), /* @__PURE__ */ h("wstack", null, data.map((item) => {
        const city = locality[1].replace("市", "");
        const cate = item.cate.replace(city, "").replace("#", "号").replace("价格", "");
        return this.content({...item, cate});
      })), /* @__PURE__ */ h("wspacer", null), gasStation.length > 0 && /* @__PURE__ */ h("wstack", {
        flexDirection: "column"
      }, this.stackGasStation(gasStation)), /* @__PURE__ */ h("wtext", {
        font: 12,
        textAlign: "right",
        opacity: 0.5
      }, "更新于:", this.nowTime()));
